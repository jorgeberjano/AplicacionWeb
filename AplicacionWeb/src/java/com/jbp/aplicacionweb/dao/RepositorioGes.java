...
import com.jbp.ges.utilidades.GestorSimbolos;
...
//        }
    ...
    public String getSqlConsulta() {
        // TODO: ver donde se mete el gestor de simbolos
        GestorSimbolos gestorSimbolos = new GestorSimbolos();
        String sql = consulta.getSql();
        return gestorSimbolos.sustituirSimbolos(sql);
    }
