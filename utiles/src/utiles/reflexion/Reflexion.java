...
public class Reflexion {
    ...
    public static void asignarValorAtributoSimple(Object objeto, String nombreAtributo, Object valor) {
        if (objeto == null) {
            return;
        }
    ...
    private static Object convertir(Class tipo, Object valor) {
        ...
        if (tipo == int.class || tipo == Integer.class) {
            valorConvertido = Integer.decode(valorString);
        } else if (tipo == long.class || tipo == Long.class) {
            valorConvertido = Long.decode(valorString);
        } else if (tipo == float.class || tipo == Float.class) {
            valorConvertido = Float.parseFloat(valorString);
            ...
            valorConvertido = Boolean.parseBoolean(valorString);
        } else if (tipo == Fecha.class) {
            valorConvertido = new Fecha(valorString);
        } else if (tipo == FechaHora.class) {
            valorConvertido = new FechaHora(valorString);
        } else {
