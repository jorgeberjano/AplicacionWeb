...
public class TablaGenerica extends JTable {
    ...
    public TablaGenerica(ModeloTablaGenerico tableModel) {    
        this();
    ...
    public void setModel(TableModel model) {
        if (model instanceof ModeloTablaGenerico) {
            setModelo((ModeloTablaGenerico) model);
        } else {
            super.setModel(model);
        }
    }
    
    public ModeloTablaGenerico getModelo() {
        return modelo;
    }
    
    public final void setModelo(ModeloTablaGenerico modelo) {
        this.modelo = modelo;
    ...
    public class ColumnListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            modelo.ordenarPor(atributo, ordenAscendente);
            table.repaint();
        }
    }
